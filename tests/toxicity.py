...
dialogue_outputs = ['''Seized Rainbow Hats Trigger Global Backlash: FIFA and Qatar Face LGBTQ+ Rights Reckoning. The bans have sparked global protests, social media outrage, and calls for action by governments and sponsors. This clash shows cultural conservatism colliding with calls for inclusivity.''']
